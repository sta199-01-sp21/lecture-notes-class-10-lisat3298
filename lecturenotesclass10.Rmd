...
The probability a randomly selected patient received the placebo is 43/84 ~ 51.2%.

- What is the probability a randomly selected patient received the placebo
  and had a marked improvement?
  
The probability a randomly selected patient received the placebo and had a marked improvement is 7/84 ~ 8.33%.
  
- What is the probability a randomly selected patient received the placebo
  and the treatment?
  
The probability a randomly selected patient received the placebo and the treatment is 0/84 ~ 0%.
  
- What is the probability a randomly selected patient had some improvement or
  was on the treatment?
  
The probability a randomly selected patient had some improvement or was on the treatment is 43 + 7 = 50/84 ~ 59.5%.
...
As the size increases, the values grow closer to the "true" probability.
...
Guess: it will be more likely for the absolute value of the difference between dice roll 1 and dice roll 2 to be equal to 4.
...
Event 2 is more likely, meaning it will be more likely for the absolute value of the difference between dice roll 1 and dice roll 2 to be equal to 4 (almost 2x as likely).
